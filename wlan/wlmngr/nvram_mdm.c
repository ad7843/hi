...
/*This file includes WLAN related nvram MDM Data Structure operation*/
...
static CmsRet wlWriteNvram(char *str)
{
...
static CmsRet wlReadNvram(char *str, int len)
{
